...
public final class PagePath {
    ...
    /**
     * The constant SHOW_FACULTIES_PAGE_REDIRECT
     **/
    public static final String SHOW_FACULTIES_PAGE_REDIRECT = "/controller?command=go_to_show_faculties";

    /**
     * The constant EDIT_RECRUITMENT_REDIRECT
     **/
    public static final String EDIT_RECRUITMENT_REDIRECT = "/controller?command=go_to_edit_recruitment";
