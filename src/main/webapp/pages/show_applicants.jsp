...
<form class="needs-validation h-75" novalidate action="${pageContext.request.contextPath}/controller" method="get"
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <input type="hidden" name="command" value="show_applicants">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="input-group p-1">
                        <div class="input-group-prepend">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                   href="${pageContext.request.contextPath}/controller?command=go_to_show_applicants_page&page=1">
            ...
            <div class="row w-75">
                <div class="col-3">
                    <c:if test="${currentPage != 1}">
                        <td>
                            <a href="${pageContext.request.contextPath}/controller?command=show_applicants&page=${currentPage - 1}&faculty_id=${faculty_id}">
                        ...
                        <tr>
                            <c:forEach begin="1" end="${countPages}" var="i">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/controller?command=show_applicants&page=${i}&faculty_id=${faculty_id}">${i}</a>
                                        </td>
                                    </c:otherwise>
                                </c:choose>
                            </c:forEach>
